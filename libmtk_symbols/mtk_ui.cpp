...
extern "C" {
    ...
    void _ZN7android16MediaBufferGroup14acquire_bufferEPPNS_11MediaBufferE(MediaBufferGroup* group, MediaBuffer **out) {
		return group->acquire_buffer(out, false, 0);
    }

    void _ZN7android16MediaBufferGroup14acquire_bufferEPPNS_11MediaBufferEb(MediaBufferGroup* group, MediaBuffer **out, bool nonBlocking) {
